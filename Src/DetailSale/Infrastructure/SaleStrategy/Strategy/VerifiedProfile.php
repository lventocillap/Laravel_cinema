...
class VerifiedProfile implements StrategySaleInterface
{
    ...
    public function __construct(
        ...
        private GetIdProfileVerificate $getIdProfileVerificate,
    ) {}
    public function registerSale(Request $request): JsonResponse
    {
        DB::transaction(function () use ($request) {
            $profileId = $this->getIdProfileVerificate->execute(new ProfileDocumentNumberRequest($request->Profile['DNI']))->id;
